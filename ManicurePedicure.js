...
const servicos = [
  { id: '1', nome: 'Mão e Pés Simples', preco: 50.00 },
  { id: '2', nome: 'Mãos e Pés com Decoração', preco: 60.00 },
  { id: '3', nome: 'Pés Simples', preco: 30.00 },
  { id: '4', nome: 'Pés com Decoração', preco: 35.00 },
  {id: '5', nome: 'Mãos Simples', preco: 30.00 },
  {id: '6', nome: 'Mãos com Decoração', preco: 40.00 },
  {id: '7', nome: 'Pés  + Reconstrução dos dedões', preco: 60.00 },
  {id: '8', nome: 'Spa dos Pés + Pedicure', preco: 100.00 },
  {id: '9', nome: 'Blindagem da Esmaltação Comum', preco: 10.00 },
];
